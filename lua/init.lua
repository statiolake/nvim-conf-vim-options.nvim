...
function M.apply(filetype)
  ...
  local l_opts = filetype and neoconf.get(string.format("vim-options.%s", filetype), {}) or {}
...
function M.setup()
  local augroup_id = vim.api.nvim_create_augroup("neoconf-vim-options", { clear = true })
